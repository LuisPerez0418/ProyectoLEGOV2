...
public class VelocidadInicialX extends javax.swing.JPanel {

    public VelocidadInicialX() {
        initComponents(); 
        vf = new VisualizarFormula("v_{ix} = v_i * cos(θ)");
        labelFUno.setIcon(vf.getIconTitulos());
        vf = new VisualizarFormula("v_{ix} = \\frac{x} {t}");
        labelFDos.setIcon(vf.getIconTitulos());
        vf = new VisualizarFormula("v_{ix} = \\sqrt{v_i^2 - v_iy^2}");
