...
public class vistaTiroVertical extends javax.swing.JPanel {
    ...
    private void mostrarAltura() {
        vista.tiroVertical.Altura vista = new vista.tiroVertical.Altura();
        vista.setSize(720, 470);
        vista.setLocation(0, 0);
        contenido.removeAll();
        contenido.add(vista, BorderLayout.CENTER);
    ...
    private void mostrarTiempo() {
        vista.tiroVertical.Tiempo vista = new vista.tiroVertical.Tiempo();
        vista.setSize(720, 470);
        vista.setLocation(0, 0);
        contenido.removeAll();
        contenido.add(vista, BorderLayout.CENTER);
    ...
    private void mostrarGravedad() {
        vista.tiroVertical.Gravedad vista = new vista.tiroVertical.Gravedad();
        vista.setSize(720, 470);
        vista.setLocation(0, 0);
        contenido.removeAll();
        contenido.add(vista, BorderLayout.CENTER);
    ...
    private void seleccionGravedad() {
